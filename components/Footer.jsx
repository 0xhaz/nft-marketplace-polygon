...
const Footer = () => {
  ...
  return (
    <footer className="flexCenter flex-col border-t dark:border-nft-black-1 border-nft-gray-1 sm:py8 py-16">
      <div className="w-full mindmd:w-4/5 flex flex-row md:flex-col sm:px-4 px-16">
